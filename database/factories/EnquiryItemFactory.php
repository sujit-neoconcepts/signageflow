...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\EnquiryItem>
 */
class EnquiryItemFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        ...
        return [
            'enquiry_id' => Enquiry::inRandomOrder()->first()?->id ?? Enquiry::factory(),
