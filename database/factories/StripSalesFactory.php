...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\StripSales>
 */
class StripSalesFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        $salesDate = $this->faker->dateTimeBetween('-1 year', 'now');
                ...
                $subTotal = $this->faker->randomFloat(2, 20000, 200000);
