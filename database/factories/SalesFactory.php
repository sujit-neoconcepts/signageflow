...
class SalesFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        $taxTotal = $subTotal * 0.18; // 18% tax
        $total = $subTotal + $taxTotal;

        return [
            'sales_number' => null, // Will be auto-generated
            ...
            'status' => $this->faker->randomElement([0, 1, 2, 3]), // Open, Partially delivered, Delivered, Closed
        ];
    }
}
