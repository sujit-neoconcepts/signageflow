...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($tableNames['model_has_permissions'], function (Blueprint $table) use ($tableNames, $columnNames, $teams) {
            $permissionPivot = app(PermissionRegistrar::class)->pivotPermission;
        ...
        Schema::create($tableNames['model_has_roles'], function (Blueprint $table) use ($tableNames, $columnNames, $teams) {
            $rolePivot = app(PermissionRegistrar::class)->pivotRole;
            ...
            if ($teams) {
                ...
                $table->primary(
                    [$columnNames['team_foreign_key'], $rolePivot, $columnNames['model_morph_key'], 'model_type'],
                    'model_has_roles_role_model_type_primary'
                );
            } else {
                $table->primary(
                    [$rolePivot, $columnNames['model_morph_key'], 'model_type'],
                    'model_has_roles_role_model_type_primary'
                );
            }
        });
