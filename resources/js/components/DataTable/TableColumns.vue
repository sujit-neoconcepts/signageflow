<template>
  <ButtonWithDropdown placement="bottom-end" dusk="columns-dropdown" :active="hasHiddenColumns" title="Show/Hide Columns"
    class>
    <template #button>
    ...
    <div role="menu" aria-orientation="horizontal" aria-labelledby="toggle-columns-menu"
      class="min-w-max max-h-[calc(100vh-221px)] overflow-y-auto">
      <div class="px-2">
        <ul class="">
