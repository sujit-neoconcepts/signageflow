...
const downloadSample = () => {
    ...
    const rows = props.sampleData.map((row) =>
        Object.values(row)
            .map((v) => {
                const str = String(v ?? "");
    ...
    a.href = url;
    a.download = `${props.resourceNeo.resourceName}_with_composition_sample.csv`;
...
<template>
    <LayoutAuthenticated>
        <Head :title="`Import ${props.resourceNeo.resourceTitle} with Composition`" />
        <SectionMain>
            <SectionTitleLineWithButton
                :icon="props.resourceNeo.iconPath"
                :title="`Import ${props.resourceNeo.resourceTitle} with Composition`"
                main
            >
                <div class="flex">
            ...
            <CardBox class="mb-6">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1">
                        ...
                        >
                            Import with Composition – Instructions
                        </h3>
                        <div
                        ...
                        <thead>
                            <tr>
                                <th
                                    ...
                                    :key="key"
                                    class="text-left font-medium text-gray-900 dark:text-white text-xs px-2 py-1 whitespace-nowrap"
                                >
                                    {{ key }}
                                </th>
                            </tr>
                        ...
                        <tbody>
                            ...
                            >
                                <td
                                    ...
                                    :key="key"
                                    class="text-gray-600 dark:text-gray-300 text-xs px-2 py-1 whitespace-nowrap"
                                >
                                    {{ value }}
                                </td>
                            </tr>
